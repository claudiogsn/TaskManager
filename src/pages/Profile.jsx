...
const ModalA = ({ isOpen, onClose }) => {
  return (
      <ReactModal
          isOpen={isOpen}
          onRequestClose={onClose}
          // Adicione aqui as configurações de estilo e outras propriedades
      >
...
Modal.setAppElement = function (tableThree) {};
Modal.setAppElement("TableThree");
...
const Profile = () => {
  ...
  //Carregar Registros para o Grid
  ...
  return (
      <div>
        <div>
          <button onClick={handleOpenModalA} className='flex justify-center rounded bg-primary p-3 font-medium text-gray' type="submit">Nova Tarefa</button>
          <ModalA isOpen={isModalAOpen} onClose={handleCloseModalA} />
        </div>
                ...
                <svg
                  ...
                  <path
                      ...
                      stroke-linejoin="round">
                                  ...
                                  <h3 className="mt-5.5 pb-2 text-xl font-bold text-black dark:text-white sm:text-2xl">Deseja excluir a tarefa ?</h3>
                                  <p className="mb-10">{task.title}</p>
                                  <div className="-mx-3 flex flex-wrap gap-y-4">
                                    <div className="w-full px-3 2xsm:w-1/2">
                                      <button className="block w-full rounded border border-stroke bg-gray p-3 text-center font-medium text-black transition hover:border-meta-1 hover:bg-meta-1 hover:text-white dark:border-strokedark dark:bg-meta-4 dark:text-white dark:hover:border-meta-1 dark:hover:bg-meta-1" control-id="ControlID-235">
                                        Cancelar
                                      </button>
                                    </div>
                                    <div className="w-full px-3 2xsm:w-1/2">
                                      <button className="block w-full rounded border border-meta-1 bg-meta-1 p-3 text-center font-medium text-white transition hover:bg-opacity-90" control-id="ControlID-239">
                                        Excluir
                                      </button>
                                    </div>
                                  </div>
